"""
Django settings for misty_moon_38650 project.
...
ROOT_URLCONF = 'misty_moon_38650.urls'
...
WSGI_APPLICATION = 'misty_moon_38650.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "misty_moon_38650 API",
    "DESCRIPTION": "API documentation for misty_moon_38650 App",
    "VERSION": "v1",
}
